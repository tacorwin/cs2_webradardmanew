...
public:
    ...
    // Fixed: previously truncated template argument; make it a vector of handles.
    SCHEMA_ADD_FIELD(c_network_utl_vector_base<c_base_handle>, m_hMyWeapons,
...
public:
    ...
    SCHEMA_ADD_FIELD(f_vector, m_vOldOrigin, "C_BasePlayerPawn->m_vOldOrigin");
...
{
public:
    SCHEMA_ADD_FIELD(c_in_game_money_services*, m_pInGameMoneyServices,
...
{
public:
    SCHEMA_ADD_FIELD_OFFSET(c_cs_weapon_base_v_data*, m_WeaponData,
        "C_BaseEntity->m_nSubclassID", 0x08);
